...
class ECIES {
  ...
  _encryptMessage (data, sharedMacData = null) {
    ...
    debug('create privateKey: ')
    debug(privateKey.toString('hex'))
    debug('remote PublicKey: ')
    debug(this._remotePublicKey.toString('hex'))
    debug('create x: ')
    debug(x.toString('hex'))
    debug('create ekey: ')
    debug(ekey.toString('hex'))
    debug('create mkey: ')
    debug(mkey.toString('hex'))
    debug('create publicKey: ')
    debug(publicKey.toString('hex'))
    debug('create dataIV: ')
    debug(dataIV.toString('hex'))
    debug('create sharedMacData: ')
    debug(sharedMacData.toString('hex'))
    debug('create tag: ')
    debug(tag.toString('hex'))
  ...
  _decryptMessage (data, sharedMacData = null) {
    ...
    debug('remote dataIV: ')
    debug(dataIV.toString('hex'))
    debug('local privateKey: ')
    debug(this._privateKey.toString('hex'))
    debug('remote x: ')
    debug(x.toString('hex'))
    debug('remote key: ')
    debug(key.toString('hex'))
    debug('remote ekey: ')
    debug(ekey.toString('hex'))
    debug('remote mkey: ')
    debug(mkey.toString('hex'))
    ...
    debug(tag.toString('hex'))
    debug('local tag: ')
    debug(_tag.toString('hex'))
    debug('locat sharedMacData: ')
    debug(sharedMacData.toString('hex'))
